...
export default function ContactSection() {
  ...
  function handleSubmit(e) {
    ...
    // TODO: підключити відправку форми (email/CRM/webhook)
    setSubmitted(true);
  }
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-16 md:grid-cols-2">
        ...
        <div className="max-w-lg">
          ...
          <div className="mt-8 space-y-5">
            ...
            <a href="mailto:kontakt@nordklar.dk" className="flex items-center gap-4">
              <span
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full"
                style={{ backgroundColor: "#EFF7FF" }}
              >
        ...
        >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-2 rounded-full py-3.5 text-base font-semibold text-white transition-colors duration-200 hover:bg-[#164FAF]"
